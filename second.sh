...
go install -u -v github.com/projectdiscovery/naabu/v2/cmd/naabu@latest;
go install github.com/tomnomnom/hacks/waybackurls@latest;
go install -u -v github.com/lukasikic/subzy@latest;
go install -v github.com/lukasikic/subzy@latest;
go install -u -v github.com/projectdiscovery/nuclei/v2/cmd/nuclei@latest;
git clone https://github.com/projectdiscovery/nuclei-templates $dir/nuclei-templates;
go install github.com/haccer/subjack@latest;
GO111MODULE=on go get -u -v github.com/projectdiscovery/subfinder/v2/cmd/subfinder
GO111MODULE=on go get -v github.com/projectdiscovery/chaos-client/cmd/chaos;
go install -u -v github.com/hahwul/dalfox@latest;
go install -u -v github.com/lc/gau@latest;
GO111MODULE=on go get -u -v github.com/lc/subjs
go install github.com/hakluke/hakcheckurl@latest;
go install github.com/hakluke/hakrawler@latest;
go install github.com/hakluke/hakrevdns@latest;
go install -u -v github.com/projectdiscovery/httpx/cmd/httpx@latest;
...
go install -u -v github.com/projectdiscovery/dnsprobe@latest;
...
go install -u -v github.com/projectdiscovery/shuffledns/cmd/shuffledns@latest;
